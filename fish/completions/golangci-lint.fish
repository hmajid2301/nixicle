...
function __golangci_lint_prepare_completions
    ...
    set -l results (__golangci_lint_perform_completion)
    __golangci_lint_debug "Completion results: $results"
    ...
    set --global __golangci_lint_comp_results $results[1..-2]
...
complete -c golangci-lint -n '__golangci_lint_prepare_completions' -f -a '$__golangci_lint_comp_results'
