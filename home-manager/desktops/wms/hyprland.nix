  ...
  config = mkIf cfg.enable {
    ...
    wayland.windowManager.hyprland = {
      ...
      extraConfig = ''
        ...
        # █▄▀ █▀▀ █▄█ █▄▄ █▀█ ▄▀█ █▀█ █▀▄   █▀▀ █▀█ █▄░█ ▀█▀ █▀█ █▀█ █░░ █▀
        # █░█ ██▄ ░█░ █▄█ █▄█ █▀█ █▀▄ █▄▀   █▄▄ █▄█ █░▀█ ░█░ █▀▄ █▄█ █▄▄ ▄█
        bindi=,XF86MonBrightnessUp,exec, ${pkgs.brightnessctl}/bin/brightnessctl +5%
        bindi=,XF86MonBrightnessDown,exec, ${pkgs.brightnessctl}/bin/brightnessctl -5% 
        bindi=,XF86AudioRaiseVolume,exec, ${pkgs.pamixer}/bin/pamixer --default-source -i 5
        bindi=,XF86AudioLowerVolume,exec, ${pkgs.pamixer}/bin/pamixer --default-source -d 5
        bindi=,XF86AudioMute,exec, ${pkgs.pamixer}/bin/pamixer --toggle-mute
        bindi=,XF86AudioMicMute,exec, ${pkgs.pamixer}/bin/pamixer --default-source --toggle-mute
