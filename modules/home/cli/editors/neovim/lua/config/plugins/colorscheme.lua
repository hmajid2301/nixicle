...
hl(0, "SnacksPickerInput", { fg = colors.white, bg = colors.black2 })
hl(0, "SnacksPickerInputBorder", { fg = colors.black2, bg = colors.black2 })
hl(0, "SnacksPickerPrompt", { fg = colors.red, bg = colors.black2 })
...
hl(0, "SnacksPickerListCursorLine", { fg = colors.white, bg = colors.one_bg })
