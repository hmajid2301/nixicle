...
-- Snacks.nvim (matching Telescope theme)
hl(0, "SnacksNormal", { bg = colors.darker_black })
hl(0, "SnacksNormalNC", { bg = colors.darker_black })
hl(0, "SnacksWinBar", { fg = colors.white, bg = colors.darker_black })
hl(0, "SnacksWinBarNC", { fg = colors.grey_fg, bg = colors.darker_black })
hl(0, "SnacksBackdrop", { bg = colors.black })
hl(0, "SnacksScratchKey", { fg = colors.blue })
hl(0, "SnacksScratchDesc", { fg = colors.grey_fg })
hl(0, "SnacksScratchSource", { fg = colors.cyan })
-- Snacks Input (matching TelescopePrompt exactly)
hl(0, "SnacksInputNormal", { fg = colors.white, bg = colors.black2 })
hl(0, "SnacksInputBorder", { fg = colors.black2, bg = colors.black2 })
hl(0, "SnacksInputTitle", { fg = colors.black, bg = colors.red, bold = true })
hl(0, "SnacksInputIcon", { fg = colors.red, bg = colors.black2 })
hl(0, "SnacksInputIconCopilot", { fg = colors.orange, bg = colors.black2 })
hl(0, "SnacksInputPrompt", { fg = colors.white, bg = colors.black2 })
hl(0, "SnacksInputPromptPrefix", { fg = colors.red, bg = colors.black2 })
-- Snacks Picker (matching Telescope theme)
hl(0, "SnacksPickerNormal", { bg = colors.darker_black })
hl(0, "SnacksPickerBorder", { fg = colors.darker_black, bg = colors.darker_black })
hl(0, "SnacksPickerTitle", { fg = colors.black, bg = colors.red, bold = true })
hl(0, "SnacksPickerFooter", { fg = colors.darker_black, bg = colors.darker_black })
hl(0, "SnacksPickerPrompt", { fg = colors.white, bg = colors.black2 })
hl(0, "SnacksPickerPromptBorder", { fg = colors.black2, bg = colors.black2 })
hl(0, "SnacksPickerPromptIcon", { fg = colors.red, bg = colors.black2 })
hl(0, "SnacksPickerPromptTitle", { fg = colors.black, bg = colors.red, bold = true })
hl(0, "SnacksPickerList", { bg = colors.darker_black })
hl(0, "SnacksPickerListBorder", { fg = colors.darker_black, bg = colors.darker_black })
hl(0, "SnacksPickerListTitle", { fg = colors.darker_black, bg = colors.darker_black, bold = true })
hl(0, "SnacksPickerPreview", { bg = colors.darker_black })
hl(0, "SnacksPickerPreviewBorder", { fg = colors.darker_black, bg = colors.darker_black })
hl(0, "SnacksPickerPreviewTitle", { fg = colors.black, bg = colors.green, bold = true })
hl(0, "SnacksPickerSelection", { fg = colors.white, bg = colors.black2 })
hl(0, "SnacksPickerMatch", { fg = colors.blue, bold = true })
hl(0, "SnacksPickerDir", { fg = colors.blue })
hl(0, "SnacksPickerFile", { fg = colors.white })
hl(0, "SnacksPickerCursor", { fg = colors.base00, bg = colors.base05 })
hl(0, "SnacksNotifierInfo", { fg = colors.green, bg = colors.darker_black })
hl(0, "SnacksNotifierWarn", { fg = colors.yellow, bg = colors.darker_black })
hl(0, "SnacksNotifierError", { fg = colors.red, bg = colors.darker_black })
hl(0, "SnacksNotifierDebug", { fg = colors.grey_fg, bg = colors.darker_black })
hl(0, "SnacksNotifierTrace", { fg = colors.purple, bg = colors.darker_black })
hl(0, "SnacksNotifierIconInfo", { fg = colors.green })
hl(0, "SnacksNotifierIconWarn", { fg = colors.yellow })
hl(0, "SnacksNotifierIconError", { fg = colors.red })
hl(0, "SnacksNotifierIconDebug", { fg = colors.grey_fg })
hl(0, "SnacksNotifierIconTrace", { fg = colors.purple })
hl(0, "SnacksNotifierTitleInfo", { fg = colors.green, bold = true })
hl(0, "SnacksNotifierTitleWarn", { fg = colors.yellow, bold = true })
hl(0, "SnacksNotifierTitleError", { fg = colors.red, bold = true })
hl(0, "SnacksNotifierTitleDebug", { fg = colors.grey_fg, bold = true })
hl(0, "SnacksNotifierTitleTrace", { fg = colors.purple, bold = true })
hl(0, "SnacksNotifierBorderInfo", { fg = colors.green })
hl(0, "SnacksNotifierBorderWarn", { fg = colors.yellow })
hl(0, "SnacksNotifierBorderError", { fg = colors.red })
hl(0, "SnacksNotifierBorderDebug", { fg = colors.grey_fg })
hl(0, "SnacksNotifierBorderTrace", { fg = colors.purple })
hl(0, "SnacksNotifierFooterInfo", { fg = colors.green })
hl(0, "SnacksNotifierFooterWarn", { fg = colors.yellow })
hl(0, "SnacksNotifierFooterError", { fg = colors.red })
hl(0, "SnacksNotifierFooterDebug", { fg = colors.grey_fg })
hl(0, "SnacksNotifierFooterTrace", { fg = colors.purple })
