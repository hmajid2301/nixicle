...
let
  ...
  fishPlugins = pkgs: [
    ...
    { name = "git-abbr"; inherit (pkgs.fishPlugins.git-abbr) src; }
    {
  ...
  den.aspects.common = {
    ...
    homeManager = { pkgs, config, lib, ... }: {
      ...
      xdg = {
        ...
        userDirs = { enable = true; createDirectories = true; setSessionVariables = false; };
      };
      programs = {
        firefox = {
          enable = true;
          ...
          profiles.default = {
            ...
            search = {
              force = true;
              default = "Kagi";
              order = [ "Kagi" "NixOS Options" "Nix Packages" "GitHub" "HackerNews" ];
              engines = {
                "Kagi" = {
                ...
                "Nix Packages" = {
                  ...
                  definedAliases = [ "@np" ];
                  urls = [{ template = "https://search.nixos.org/packages"; params = [{ name = "type"; value = "packages"; } { name = "query"; value = "{searchTerms}"; } { name = "channel"; value = "unstable"; }]; }];
                  metaData.hideOneOffButton = true;
                };
                "NixOS Options" = {
                  icon = "https://nixos.org/_astro/flake-blue.Bf2X2kC4_Z1yqDoT.svg";
                  definedAliases = [ "@no" ];
                  urls = [{ template = "https://search.nixos.org/options"; params = [{ name = "channel"; value = "unstable"; } { name = "query"; value = "{searchTerms}"; }]; }];
                  metaData.hideOneOffButton = true;
                };
                "GitHub" = {
                ...
                "Home Manager" = {
                  ...
                  definedAliases = [ "@hm" ];
                  urls = [{ template = "https://mipmip.github.io/home-manager-option-search/"; params = [{ name = "query"; value = "{searchTerms}"; }]; }];
                  metaData.hideOneOffButton = true;
                };
                "HackerNews" = {
                  icon = "https://news.ycombinator.com/favicon.ico";
                  definedAliases = [ "@hn" ];
                  urls = [{ template = "https://hn.algolia.com/"; params = [{ name = "q"; value = "{searchTerms}"; }]; }];
                  metaData.hideOneOffButton = true;
                };
              };
            };
        ...
        fish = {
          ...
          shellAbbrs = {
            vim = "nvim"; n = "nvim"; cd = "z"; cdi = "zi"; cp = "xcp";
            grep = "rg"; dig = "doggo"; cat = "bat"; curl = "curlie";
            rm = "gomi"; ping = "gping"; ls = "eza"; sl = "eza";
            l = "eza --group --header --group-directories-first --long --git --all --binary --all --icons always";
            tree = "eza --tree"; sudo = "sudo -E"; k = "kubectl";
            kgp = "kubectl get pods"; tsu = "tailscale up"; tsd = "tailscale down";
            nhh = "nh home switch"; nho = "nh os switch"; nhu = "nh os --update";
            nd = "nix develop"; nfu = "nix flake update";
