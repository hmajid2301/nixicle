# haseebmajid user aspect — standalone home for the non-NixOS dell machine.
# Extends den.aspects.haseebmajid (auto-created from den.homes declaration).
{ den, ... }:
{
        ...
        configFile."fontconfig/conf.d/99-custom-fonts.conf".text = ''
          ...
          <fontconfig>
            ...
            <match target="pattern">
              ...
              <edit name="family" mode="assign"><string>Source Serif</string></edit>
            </match>
            <match target="pattern">
              <test qual="any" name="family"><string>monospace</string></test>
              <edit name="family" mode="assign"><string>MonoLisa</string></edit>
            </match>
            <match target="pattern">
            ...
            <match target="pattern">
              <test name="family"><string>monospace</string></test>
              <edit name="family" mode="append"><string>DejaVu Sans Mono</string></edit>
            </match>
            <match target="pattern">
