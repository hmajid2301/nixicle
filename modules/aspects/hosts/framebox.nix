# framebox host aspect — extends the auto-created den.aspects.framebox.
# Replaces hosts/framebox/default.nix role/service enablement.
{ den, inputs, ... }:
{
        ...
        nixicle = {
          ...
          btrbk = {
            ...
            instances.local = {
              ...
              retention = { weekly = 2; monthly = 6; };
            };
            backblaze = {
              enable = true;
              bucket = "Majiy00Homelab";
              endpoint = "s3.us-west-004.backblazeb2.com";
              paths = [ "/persist/.snapshots" "/home/.snapshots" ];
              onCalendar = "weekly";
            };
          };
          cloudflare = {
